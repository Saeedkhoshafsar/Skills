...
2. Begin with SENSE: `docs/STATE.md` first if it exists, then only what the
   resume packet points to. Choose one operating mode. Prefer the fast path
   when STATE, Vision Lock, plan, and evidence are coherent.
